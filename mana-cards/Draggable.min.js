...
!(function (e, t) {
  ...
  var h,
    ...
    M = function _setDoc(e) {
      ...
      !(b in e.style) &&
        ...
        (T = (b = "msTransform") + "Origin");
      for (; t.parentNode && (t = t.parentNode); );
      if (((f = window), (m = new ge()), t)) {
    ...
    E = function _forceNonZeroScale(e) {
      for (var t, n; e && e !== a; )
    ...
    L = function _getDocScrollTop() {
      return f.pageYOffset || h.scrollTop || i.scrollTop || a.scrollTop || 0;
    },
    C = function _getDocScrollLeft() {
      return f.pageXOffset || h.scrollLeft || i.scrollLeft || a.scrollLeft || 0;
    },
    ...
    k = function _placeSiblings(e, t) {
      var n,
        ...
        p = e.parentNode,
        u =
          p && !s && p.shadowRoot && p.shadowRoot.appendChild
            ? p.shadowRoot
            : p;
      if (e === f) return e;
      if ((d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), (n = s ? x : g), s))
        c
          ? ((i =
        ...
        if (((i = a = 0), y))
          for (
            ...
            4 < (f.getComputedStyle(r)[b] + "").length &&
              ((i = r.offsetLeft), (a = r.offsetTop), (r = 0));
        if (
          "absolute" !== (l = f.getComputedStyle(e)).position &&
          "fixed" !== l.position
        )
  ...
  function Da(e) {
    (De = e.touches && Pe < e.touches.length), Aa(e.target, "touchend", Da);
  }
  function Ea(e) {
    (De = e.touches && Pe < e.touches.length), za(e.target, "touchend", Da);
  }
  function Fa(e) {
    return (
      me.pageYOffset ||
  ...
  function Ka(e, t) {
    ...
    return Math.max(
      0,
      Qe(e)
        ? Math.max(ye[o], l[o]) - (me["inner" + n] || ye[r] || l[r])
        : e[o] - e[r]
    );
  }
  function La(e, t) {
  ...
  function _a(e) {
    if (X() && document.body) {
      ...
      (me = window),
        (ve = document),
        (ye = ve.documentElement),
        (l = ve.body),
        (s = fa("div")),
        (Ae = !!window.PointerEvent),
        ...
        (Me =
          ("ontouchstart" in ye && "orientation" in me) ||
        ...
        za(ve, "touchcancel", aa),
        za(me, "touchmove", aa),
        l && l.addEventListener("touchstart", aa),
        za(ve, "contextmenu", function () {
          for (var e in Ie) Ie[e].isPressed && Ie[e].endDrag();
        }),
        (xe = be = Y());
    }
    var n, o, r, i, a;
    xe
      ? ((_e = xe.plugins.inertia),
        (Le = xe.core.context || function () {}),
        (c = xe.utils.checkPrefix),
        (O = c(O)),
        (Ye = c(Ye)),
        (Te = xe.utils.toArray),
        (Ce = xe.core.getStyleSaver),
        (B = !!c("perspective")))
  ...
  var xe,
    ...
    p = {},
    Ge = {},
    u = function _getElementBounds(e, t) {
      t = Te(t)[0];
      var n,
        o,
        r,
  ...
  function Draggable(h, p) {
    ...
    (e = Ve.call(this) || this),
      be || _a(1),
      (h = Te(h)[0]),
      (e.styles = Ce && Ce(h, "transform,left,top")),
      (_e = _e || xe.plugins.inertia),
      (e.vars = p = ra(p || {})),
      (e.target = h),
    ...
    function Ah(e) {
      if (J.autoScroll && J.isDragging && (te || C)) {
        var t,
          n,
          o,
          r,
        ...
        for (
          te = !1,
            ...
            We.scrollLeft =
              null != me.pageXOffset
                ...
                : de.body.scrollLeft,
            r = J.pointerX - We.scrollLeft,
            i = J.pointerY - We.scrollTop;
          c && !n;
          ...
          (t = (n = Qe(c.parentNode)) ? We : c.parentNode),
            (o = n
              ? {
                  bottom: Math.max(ye.clientHeight, me.innerHeight || 0),
                  right: Math.max(ye.clientWidth, me.innerWidth || 0),
                  left: 0,
                  top: 0,
                }
      ...
      if (C) {
        ...
        Q
          ...
          : f
          ? (U && ((J.deltaY = u - f.top()), f.top(u)),
            K && ((J.deltaX = p - f.left()), f.left(p)))
          : W
          ? (U && ((J.deltaY = u - parseFloat(se.y)), (se.y = u + "px")),
            K && ((J.deltaX = p - parseFloat(se.x)), (se.x = p + "px")),
            se.renderTransform(1, se))
          : (U &&
              ((J.deltaY = u - parseFloat(h.style.top || 0)),
              (h.style.top = u + "px")),
            K &&
              ((J.deltaX = p - parseFloat(h.style.left || 0)),
              (h.style.left = p + "px"))),
          !g ||
            e ||
            I ||
            (!(I = !0) === Qa(J, "drag", "onDrag") &&
              (K && (J.x -= J.deltaX), U && (J.y -= J.deltaY), Ah(!0)),
            (I = !1));
      }
      C = !1;
    }
    function Bh(e, t) {
      ...
      h._gsap || (se = xe.core.getCache(h)),
        ...
        W
          ...
          : ((J.y = parseFloat(h.style.top || ((o = Na(h)) && o.top)) || 0),
        ...
        (P || Y || N) &&
          ...
          (N &&
            ((He.x = J.x),
            (He.y = J.y),
            (n = N(He)).x !== J.x && ((J.x = n.x), (C = !0)),
            n.y !== J.y && ((J.y = n.y), (C = !0))),
          P &&
            (n = P(J.x)) !== J.x &&
            ((J.x = n), Q && (J.rotation = n), (C = !0)),
          Y && ((n = Y(J.y)) !== J.y && (J.y = n), (C = !0))),
        C && Ah(!0),
        e ||
          ((J.deltaX = J.x - r),
          (J.deltaY = J.y - i),
    ...
    function Ch(a, l, s, n) {
      return (
        ...
        Z(a)
          ...
          : Ne(a)
          ? function (e) {
              for (var t, n, o = a.length, r = 0, i = Be; -1 < --o; )
                (n = (t = a[o]) - e) < 0 && (n = -n),
                  n < i && l <= t && t <= s && ((r = o), (i = n));
              return a[r];
            }
    ...
    function Eh() {
      ...
      (E = !1),
        f
          ? (f.calibrate(),
            (J.minX = S = -f.maxScrollLeft()),
            (J.minY = A = -f.maxScrollTop()),
            (J.maxX = D = J.maxY = X = 0),
            (E = !0))
          : p.bounds &&
            ...
            Q
              ...
              ? ((t = Ra(h, h.parentNode)),
                (J.minX = S = Math.round(Sg(G, "px") + e.left - t.left)),
                (J.minY = A = Math.round(Sg(V, "px") + e.top - t.top)),
                (J.maxX = D = Math.round(S + (e.width - t.width))),
                (J.maxY = X = Math.round(A + (e.height - t.height))))
              : ((e = p.bounds),
                (J.minX = S = e.minX),
                (J.minY = A = e.minY),
                (J.maxX = D = e.maxX),
            ...
            X < A && ((J.minY = X), (J.maxY = X = A), (A = J.minY)),
            Q && ((J.minRotation = S), (J.maxRotation = D)),
            (E = !0)),
        p.liveSnap &&
          ((n = !0 === p.liveSnap ? p.snap || {} : p.liveSnap),
          (o = Ne(n) || Z(n)),
          Q
            ? ((P = Ch(o ? n : n.rotation, S, D, 1)), (Y = null))
            : n.points
            ? (N = (function buildPointSnapFunc(s, l, c, d, p, u, h) {
                return (
                  ...
                  Z(s)
                    ...
                    ? function (e) {
                        for (
                          var t, n, o, r, i = s.length, a = 0, l = Be;
                          -1 < --i;
              ...
              })(o ? n : n.points, S, D, A, X, n.radius, f ? -1 : 1))
            : (K &&
                (P = Ch(
    ...
    function Hh(e, t) {
      ...
      e && _e
        ? (!0 === e &&
            ...
            Q
              ? (e.rotation = Ua(J, o ? n : n.rotation, D, S, 1, t))
              : (K &&
                  (e[G] = Ua(
                    J,
                ...
                (n.points || (Ne(n) && $(n[0]))) &&
                  ((e.linkedProps = G + "," + V), (e.radius = n.radius)))),
          (J.isThrowing = !0),
    ...
    function Jh() {
      ...
      W &&
        ...
        (w = Ge.x),
        (b = Ge.y),
        C && (he(J.pointerX, J.pointerY), Ah(!0)),
        (d = getGlobalMatrix(h)),
        f
          ? (Eh(), (M = f.top()), (T = f.left()))
          : (pe() ? (Bh(!0, !0), Eh()) : J.applyBounds(),
            Q
              ? ((e = h.ownerSVGElement
                ...
                (n = L.y - J.pointerY + i),
                (T = J.x),
                (M = J.y = Math.atan2(n, t) * ke))
              : ((M = Sg(V, "px")), (T = Sg(G, "px")))),
        E &&
          o &&
          (D < T ? (T = D + (T - D) / o) : T < S && (T = S - (S - T) / o),
          Q ||
            (X < M ? (M = X + (M - X) / o) : M < A && (M = A - (A - M) / o))),
        (J.startX = T = da(T)),
        (J.startY = M = da(M));
    }
    function Lh() {
      !we.parentNode || pe() || J.isDragging || we.parentNode.removeChild(we);
    }
    function Mh(e, t) {
      var n;
      if (
        ...
        if (
          ...
          (v = ae.call(J, e.target) && !1 === p.dragClickables && !t))
        )
          return (
        ...
        if (
          ...
          Qa(J, "pressInit", "onPressInit"),
          (R || J.autoScroll) && La(h.parentNode),
          !h.parentNode ||
            !J.autoScroll ||
            f ||
            Q ||
          ...
          (J.isPressed = !0),
          (g = !(!p.onDrag && !J._listeners.drag)),
          (s = !(!p.onMove && !J._listeners.move)),
          !1 !== p.cursor || p.activeCursor)
        )
          for (n = q.length; -1 < --n; )
            xe.set(q[n], {
              cursor:
                p.activeCursor || p.cursor || ("grab" === Xe ? "grabbing" : Xe),
            });
        Qa(J, "press", "onPress");
      }
    }
    ...
    function Rh(e) {
      ...
      (J.isPressed || o || n) && ((l && e.detail && n && !i) || Ba(e)),
        n ||
          o ||
          H ||
    ...
    var u,
      ...
      ue = function onMove(e) {
        ...
        if (u && !De && J.isPressed && e) {
          ...
          (((i = Math.abs(n - w)) !== (a = Math.abs(o - b)) &&
            ...
            (Se && R === O)) &&
            ((O = a < i && K ? "x" : "y"),
            R && O !== R && za(me, "touchforcechange", Ba),
            !1 !== J.vars.lockAxisOnTouchScroll &&
              K &&
              U &&
              ((J.lockedAxis = "x" === O ? "y" : "x"),
              Z(J.vars.onLockAxis) && J.vars.onLockAxis.call(J, l)),
            Se && R === O))
            ? fe(l)
            : ((z =
                J.allowEventDefault ||
      ...
      he = function setPointerPosition(e, t, n) {
        ...
        (J.pointerX = e),
          ...
          ce && ((e -= Ga(de)), (t -= Fa(de))),
          Q
            ? ((a = Math.atan2(L.y - t, e - L.x) * ke),
              180 < (l = J.y - a)
                ? ((M -= 360), (J.y = a))
                : l < -180 && ((M += 360), (J.y = a)),
              (i =
                J.x !== T || Math.max(Math.abs(w - e), Math.abs(b - t)) > j
                  ? ((J.y = a), T + (M - a) * c)
                  : T))
            : (k &&
                ((s = e * k.a + t * k.c + k.e),
          ...
          E &&
            (D < i
              ? (i = D + Math.round((i - D) * d))
              : i < S && (i = S + Math.round((i - S) * d)),
            Q ||
              (X < a
                ? (a = Math.round(X + (a - X) * d))
                : a < A && (a = Math.round(A + (a - A) * d)))),
          (J.x === i && (J.y === a || Q)) ||
            (Q
              ? ((J.endRotation = J.x = J.endX = i), (C = !0))
              : (U && ((J.y = J.endY = a), (C = !0)),
                K && ((J.x = J.endX = i), (C = !0))),
            n && !1 === Qa(J, "move", "onMove")
              ? ((J.pointerX = p),
                (J.pointerY = u),
                (M = h),
                (J.x = f),
              ...
              : !J.isDragging &&
                J.isPressed &&
                ((J.isDragging = H = !0), Qa(J, "dragstart", "onDragStart")));
      },
      fe = function onRelease(e, t) {
        if (
          ...
          if (
            ...
            (C = !1),
            s && ((ee = ze = Re()), (J.isDragging = !1)),
            xa(Ah),
            v && !c)
          )
            return (
              e && (Aa(e.target, "change", onRelease), (J.pointerEvent = l)),
              Wa(q, !1),
          ...
          for (o = q.length; -1 < --o; )
            Ma(q[o], "cursor", p.cursor || (!1 !== p.cursor ? Xe : null));
          if ((Pe--, e)) {
            if (
              (n = e.changedTouches) &&
              (e = n[0]) !== x &&
          ...
          return (
            c && l
              ? (Ba(l), (z = !0), Qa(J, "release", "onRelease"))
              : l && !s
              ? ((z = !1),
                B && (p.snap || p.bounds) && Hh(p.inertia || p.throwProps),
                Qa(J, "release", "onRelease"),
                (Se && "touchmove" === l.type) ||
                  -1 !== l.type.indexOf("cancel") ||
                  (Qa(J, "click", "onClick"),
                  Re() - le < 300 && Qa(J, "doubleclick", "onDoubleClick"),
                  (i = l.target || h),
                  (le = Re()),
                  ...
                  Se || l.defaultPrevented || xe.delayedCall(0.05, a)))
              : (Hh(p.inertia || p.throwProps),
                J.allowEventDefault ||
                !l ||
                (!1 === p.dragClickables && ae.call(J, l.target)) ||
                !s ||
                (R && (!O || R !== O)) ||
                !1 === l.cancelable
                  ? (z = !1)
    ...
    return (
      ...
      (e.startDrag = function (e, t) {
        var n, o, r, i;
        Mh(e || J.pointerEvent, !0),
          t &&
            !J.hitTest(e || J.pointerEvent) &&
            ((n = Pa(e || J.pointerEvent)),
            (o = Pa(h)),
            (r = Sh({ x: n.left + n.width / 2, y: n.top + n.height / 2 })),
            (i = Sh({ x: o.left + o.width / 2, y: o.top + o.height / 2 })),
            (w -= r.x - i.x),
            (b -= r.y - i.y)),
          J.isDragging ||
            ((J.isDragging = H = !0), Qa(J, "dragstart", "onDragStart"));
      ...
      (e.endDrag = function (e) {
        return fe(e || J.pointerEvent, !0);
      }),
      (e.timeSinceDrag = function () {
        return J.isDragging ? 0 : (Re() - ee) / 1e3;
      }),
      ...
      (e.getDirection = function (e, t) {
        var n,
          ...
          a,
          l,
          s = "velocity" === e && _e ? e : $(e) && !Q ? "element" : "start";
        return (
          "element" === s && ((a = Pa(J.target)), (l = Pa(e))),
          (n =
            "start" === s
              ? J.x - T
              : "velocity" === s
        ...
        if ((Bh(!0), Eh(), E && !pe())) {
          if (
            ...
            (J.x !== n || J.y !== o) &&
              ((r = !0),
              (J.x = J.endX = n),
              Q ? (J.endRotation = n) : (J.y = J.endY = o),
              Ah((C = !0)),
            ...
            for (
              ...
              (a = (l = Qe(i.parentNode)) ? We : i.parentNode),
                ...
                (i = a);
          J.isThrowing &&
            (r || J.endX > D || J.endX < S || J.endY > X || J.endY < A) &&
            Hh(p.inertia || p.throwProps, r);
        }
        return J;
      }),
      (e.update = function (e, t, n) {
        ...
        return (
          Ih(!t),
          e ? J.applyBounds() : (C && n && Ah(!0), Bh(!0)),
          t && (he(J.pointerX, J.pointerY), C && Ah(!0)),
          J.isPressed &&
            !t &&
            ((K && 0.01 < Math.abs(a - J.x)) ||
              (U && 0.01 < Math.abs(l - J.y) && !Q)) &&
            Jh(),
          J.autoScroll &&
            (La(h.parentNode, J.isDragging),
            (te = J.isDragging),
            Ah(!0),
            Ia(h, Qh),
            Ha(h, Qh)),
        ...
        if (
          ...
          for (
            ...
            (o = q[n]),
              ...
              p.allowContextMenu || za(o, "contextmenu", zh);
          Wa(q, !1);
        }
        return (
          Ha(h, Qh),
          ...
          _e &&
            "soft" !== e &&
            _e.track(f || h, W ? "x,y" : Q ? "rotation" : "top,left"),
          (h._gsDragID = t = h._gsDragID || "d" + Fe++),
          (Ie[t] = J),
      ...
      (e.disable = function (e) {
        ...
        return (
          ...
          _e &&
            "soft" !== e &&
            (_e.untrack(f || h, W ? "x,y" : Q ? "rotation" : "top,left"),
            J.tween && J.tween.kill()),
          f && f.disable(),
          xa(Ah),
          (J.isDragging = J.isPressed = v = !1),
          n && Qa(J, "dragend", "onDragEnd"),
          J
        );
      }),
      ...
      (e.kill = function () {
        return (
          ...
          J.tween && J.tween.kill(),
          J.disable(),
          xe.set(q, { clearProps: "userSelect" }),
          delete Ie[h._gsDragID],
          J
        );
      }),
      (e.revert = function () {
      ...
      ~n.indexOf("scroll") &&
        ...
        (h = f.content)),
      Q ? (o.rotation = 1) : (K && (o[G] = 1), U && (o[V] = 1)),
